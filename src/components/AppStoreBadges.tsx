  ...
  return (
    <div className={compact ? "flex items-center gap-2" : "flex flex-col items-center gap-3"}>
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          href="#"
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-secondary/80 border border-border/40 hover:border-gold/30 transition-all text-xs text-foreground"
        >

...
export function PublicFooter({ className = "", activePage }: PublicFooterProps) {
  return (
    <footer className={`relative z-10 border-t border-gold/10 py-10 px-4 text-center text-sm text-muted-foreground ${className}`}>
      <div className="max-w-5xl mx-auto space-y-5">
        ...
        <div className="flex items-center justify-center gap-3">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-2 rounded-lg bg-card/60 border border-border/30 hover:border-gold/30 hover:text-gold transition-all">
          ...
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2 rounded-lg bg-card/60 border border-border/30 hover:border-gold/30 hover:text-gold transition-all">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="p-2 rounded-lg bg-card/60 border border-border/30 hover:border-gold/30 hover:text-gold transition-all">
          ...
          <a href="https://wa.me/972501234567" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="p-2 rounded-lg bg-[hsl(142,70%,45%)]/10 border border-[hsl(142,70%,45%)]/30 text-[hsl(142,70%,45%)] hover:bg-[hsl(142,70%,45%)]/20 transition-all">
